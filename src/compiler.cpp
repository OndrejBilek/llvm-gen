...
llvm::Value *Compiler::zero = llvm::ConstantInt::get(llvm::getGlobalContext(), llvm::APInt(32, 0));

llvm::Value *Compiler::one = llvm::ConstantInt::get(llvm::getGlobalContext(), llvm::APInt(32, 1));

llvm::LLVMContext &Compiler::context = llvm::getGlobalContext();
}
